...
`diamonds` have the variables: carat, cut, color, clarity, depth, table,
price, x, y, z
...
-   (Write your observations here!) carat is between 0 and 5. The
    maximum price of a diamond is 18823.
