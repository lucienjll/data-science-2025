...
diamonds have the variables: carat, cut, color, clarity, depth, table, price, x, y, z
...
As the carat increases, price increases, though the trend can't be defined by a single curve
...
Aesthetics also accepts alpha, color, fill, group, shape, size, stroke
```{r}
?geom_point()
```
...
-   (Write your observations here!)
The cuts that are higher tiers tend to cost more for each carat rating. The fair ones tend to be cheaper than the higher tiers. 
