...
-   Make a quantitative comparison between Michelson's uncertainty and
    ...
    -   The true error was 151.542 km/s. Michelson's uncertainty caused
        him to give an error estimate of +/—56, with a full range of 102
        km/s. This means that Michelson's uncertainty wasn't able to
        capture the value of the true error.
