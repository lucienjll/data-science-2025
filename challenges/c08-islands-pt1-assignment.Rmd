...
-   Are there any sources of *erroneous* uncertainty in the percent occupied you calculated?
    -   No because I don't think there are actions that we researchers can do to force homes to be occupied/unoccupied.
...
-   Is this sample representative of *all* houses in Helvig? Why or why not?
    -   No because the names may be biases due to folks living in the same household most likely having the same name.
