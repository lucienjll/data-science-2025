...
-   Which rows did you pick?
    -   I picked rows that didn't have NA values and values that were within in lower and upper quartiles. I also filtered out countries that had populations that were less than 10000. 
-   Why?
    -   I decided to filter out the data because they skewed the mean too much. When we normalized the data to that per 100k, small population countries with around a hundred deaths would result in around a thousand deaths, which would skew the data too much. 
